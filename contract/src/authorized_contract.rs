...
use casper_types::{
    ...
    Key, Parameter, RuntimeArgs, URef,
};
...
#[no_mangle]
pub extern "C" fn add_urefs() {
    let uref: URef = runtime::get_named_arg("uref");
    runtime::put_key(GROUP_UREF_NAME, uref.into());
}
...
pub extern "C" fn call() {
    ...
    let entry_point_1 = EntryPoint::new(
        "add_urefs",
        vec![Parameter::new("uref".to_string(), CLType::URef)],
        CLType::Unit,
    ...
    runtime::put_key("authorized_contract", contract_hash.into());
}
